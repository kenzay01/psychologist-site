...
export default function BlogsBlock() {
  ...
  useEffect(() => {
    // Check window width to determine number of blogs to display
    const updateDisplayCount = () => {
      if (typeof window !== "undefined") {
        setDisplayCount(window.innerWidth < 640 ? 1 : 3);
      }
    };
          ...
          <>
            ...
            <div className="text-center">
              <button
                ...
                className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-xl font-semibold text-base md:text-lg inline-flex items-center gap-2 justify-center hover:scale-102 transition-all duration-300 shadow-md"
              >
                {dict?.blogs?.cta?.readAll || "Читати всі блоги"}
