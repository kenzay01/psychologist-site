      ...
      <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="space-y-4 md:space-y-8">
            <div className="relative">
              <Image
                ...
                loading="lazy"
              />
              <div className="relative mt-4 md:mt-0 md:absolute md:-bottom-6 md:-right-6 bg-red-500 text-white p-6 rounded-2xl shadow-lg max-w-sm">
                <blockquote className="text-sm font-medium italic">
                  «Зі мною можна по-справжньому: без сорому, без `правильно` чи
                  `неправильно`. Я створюю безпечний простір для справжніх
                  розмов»
                </blockquote>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Я не працюю за готовими шаблонами. Кожна людина унікальна, тому
                терапія вибудовується саме під ваші потреби, темп і особливості.
                Створюю безпечний простір, де можна говорити про важке, сумне,
                інтимне — все, що справжнє.
              </p>
              <div className="border-l-4 border-red-500 pl-4">
                <p className="text-gray-700 font-medium">
                  Працюю з повагою до ваших кордонів, досвіду та темпу. Не даю
                  готових порад — разом досліджуємо, що саме для вас є правдою,
                  ресурсом і виходом.
                </p>
              </div>
            </div>
        ...
        <div className="bg-red-500 rounded-3xl p-6 md:p-12 text-center text-white">
          ...
          <button
            ...
            className="bg-white text-red-600 px-12 py-4 rounded-bl-md rounded-br-3xl rounded-tl-3xl rounded-tr-md font-semibold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
